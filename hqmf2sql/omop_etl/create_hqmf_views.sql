...
-- all encounters.
create materialized view encounter as select
...
create materialized view procedure_performed as select * from procedure_view where status in ('performed', 'null')
...
create materialized view laboratory_test as select
  person_id as patient_id,
...
create materialized view diagnostic_study_result as select * from laboratory_test
...
create materialized view individual_characteristic as select
   person_id as patient_id,
