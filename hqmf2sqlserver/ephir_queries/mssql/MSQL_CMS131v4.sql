...
create view results.measure_131_0_all as SELECT patient_base.base_patient_id,
  ...
  (SELECT CASE WHEN EXISTS
     (SELECT anon_2.patient_id,
      ...
      FROM
        (SELECT dc_26.hqmf_cypress_ep_physical_exam_performed_patient_id AS patient_id,
                dc_26.hqmf_cypress_ep_physical_exam_performed_start_dt AS start_dt,
                dc_26.hqmf_cypress_ep_physical_exam_performed_end_dt AS end_dt,
                dc_26.hqmf_cypress_ep_physical_exam_performed_audit_key_value AS audit_key_value
         FROM
           (SELECT physical_exam_performed_1.patient_id AS hqmf_cypress_ep_physical_exam_performed_patient_id,
            ...
            FROM hqmf_test.physical_exam_performed AS physical_exam_performed_1
            JOIN
            valuesets.code_lists AS code_lists_1 ON code_lists_1.code = physical_exam_performed_1.code
            ...
            WHERE physical_exam_performed_1.patient_id = patient_base.base_patient_id
              ...
              AND physical_exam_performed_1.end_dt < CAST('2015-01-01 00:00:00' AS DATETIME)
              AND results.month_delta(physical_exam_performed_1.end_dt, CAST('2015-01-01 00:00:00' AS DATETIME)) >= 0
              AND results.month_delta(physical_exam_performed_1.end_dt, CAST('2015-01-01 00:00:00' AS DATETIME)) <= 12) AS dc_26
         WHERE dc_26.hqmf_cypress_ep_physical_exam_performed_end_dt < CAST('2015-01-01 00:00:00' AS DATETIME)
           AND results.month_delta(dc_26.hqmf_cypress_ep_physical_exam_performed_end_dt, CAST('2015-01-01 00:00:00' AS DATETIME)) >= 0
           AND results.month_delta(dc_26.hqmf_cypress_ep_physical_exam_performed_end_dt, CAST('2015-01-01 00:00:00' AS DATETIME)) <= 12
         UNION SELECT dc_27.hqmf_cypress_ep_physical_exam_performed_patient_id AS patient_id,
                      dc_27.hqmf_cypress_ep_physical_exam_performed_start_dt AS start_dt,
                      dc_27.hqmf_cypress_ep_physical_exam_performed_end_dt AS end_dt,
                      dc_27.hqmf_cypress_ep_physical_exam_performed_audit_key_value AS audit_key_value
         FROM
           (SELECT physical_exam_performed_1.patient_id AS hqmf_cypress_ep_physical_exam_performed_patient_id,
                   physical_exam_performed_1.start_dt AS hqmf_cypress_ep_physical_exam_performed_start_dt,
                   physical_exam_performed_1.end_dt AS hqmf_cypress_ep_physical_exam_performed_end_dt,
            ...
            FROM hqmf_test.physical_exam_performed AS physical_exam_performed_1
            JOIN
            valuesets.code_lists AS code_lists_2 ON code_lists_2.code = physical_exam_performed_1.code
            AND code_lists_2.code_list_id = '2.16.840.1.113883.3.464.1003.115.12.1088'
            WHERE physical_exam_performed_1.patient_id = patient_base.base_patient_id
              AND (CAST(physical_exam_performed_1.negation AS BIT) IS NULL
                   OR CAST(physical_exam_performed_1.negation AS BIT) = 0)
              AND physical_exam_performed_1.start_dt >= CAST('2015-01-01 00:00:00' AS DATETIME)
              AND physical_exam_performed_1.end_dt <= CAST('2015-12-31T00:00:00' AS DATETIME)) AS dc_27
         WHERE dc_27.hqmf_cypress_ep_physical_exam_performed_start_dt >= CAST('2015-01-01 00:00:00' AS DATETIME)
           AND dc_27.hqmf_cypress_ep_physical_exam_performed_end_dt <= CAST('2015-12-31T00:00:00' AS DATETIME)) AS anon_2) 
		   THEN cast( 1 as bit)  
		   ELSE cast(0 as bit)
		   END AS anon_1) AS numerator,

  (SELECT CASE WHEN (EXISTS
             (SELECT dc_28.hqmf_cypress_ep_diagnosis_active_patient_id,
                     dc_28.hqmf_cypress_ep_diagnosis_active_start_dt,
                     dc_28.hqmf_cypress_ep_diagnosis_active_end_dt,
                     dc_28.hqmf_cypress_ep_diagnosis_active_audit_key_value
              FROM
                (SELECT diagnosis_active_1.patient_id AS hqmf_cypress_ep_diagnosis_active_patient_id,
                 ...
                 WHERE diagnosis_active_1.patient_id = patient_base.base_patient_id
                   ...
                   AND (diagnosis_active_1.end_dt >= CAST('2015-01-01 00:00:00' AS DATETIME)
                        ...
                        AND diagnosis_active_1.end_dt IS NULL)) AS dc_28))
   AND (EXISTS
          (SELECT dc_29.hqmf_cypress_ep_patient_characteristic_birthdate_patient_id,
                  dc_29.hqmf_cypress_ep_patient_characteristic_birthdate_start_dt,
                  dc_29.hqmf_cypress_ep_patient_characteristic_birthdate_end_dt,
                  dc_29.hqmf_cypress_ep_patient_characteristic_birthdate_audit_key_value
           FROM
             (SELECT patient_characteristic_birthdate_1.patient_id AS hqmf_cypress_ep_patient_characteristic_birthdate_patient_id,
              ...
              WHERE patient_characteristic_birthdate_1.patient_id = patient_base.base_patient_id
                ...
                AND results.year_delta(patient_characteristic_birthdate_1.start_dt, CAST('2015-01-01 00:00:00' AS DATETIME)) >= 18) AS dc_29))
   AND (EXISTS
          (SELECT dc_30.hqmf_cypress_ep_patient_characteristic_birthdate_patient_id,
                  dc_30.hqmf_cypress_ep_patient_characteristic_birthdate_start_dt,
                  dc_30.hqmf_cypress_ep_patient_characteristic_birthdate_end_dt,
                  dc_30.hqmf_cypress_ep_patient_characteristic_birthdate_audit_key_value
           FROM
             (SELECT patient_characteristic_birthdate_1.patient_id AS hqmf_cypress_ep_patient_characteristic_birthdate_patient_id,
                     patient_characteristic_birthdate_1.start_dt AS hqmf_cypress_ep_patient_characteristic_birthdate_start_dt,
                     patient_characteristic_birthdate_1.end_dt AS hqmf_cypress_ep_patient_characteristic_birthdate_end_dt,
              ...
              WHERE patient_characteristic_birthdate_1.patient_id = patient_base.base_patient_id
                ...
                AND results.year_delta(patient_characteristic_birthdate_1.start_dt, CAST('2015-01-01 00:00:00' AS DATETIME)) < 75) AS dc_30))
   AND (EXISTS
          (SELECT anon_4.patient_id,
           ...
           FROM
             (SELECT dc_39.hqmf_cypress_ep_encounter_performed_patient_id AS patient_id,
              ...
              FROM
                (SELECT encounter_performed_1.patient_id AS hqmf_cypress_ep_encounter_performed_patient_id,
                 ...
                 WHERE encounter_performed_1.patient_id = patient_base.base_patient_id
                   AND (CAST(encounter_performed_1.negation AS BIT) IS NULL
                        OR CAST(encounter_performed_1.negation AS BIT) = 0)) AS dc_41
              UNION SELECT dc_42.hqmf_cypress_ep_encounter_performed_patient_id AS patient_id,
                           dc_42.hqmf_cypress_ep_encounter_performed_start_dt AS start_dt,
                           dc_42.hqmf_cypress_ep_encounter_performed_end_dt AS end_dt,
                           dc_42.hqmf_cypress_ep_encounter_performed_audit_key_value AS audit_key_value
              FROM
                (SELECT encounter_performed_1.patient_id AS hqmf_cypress_ep_encounter_performed_patient_id,
                        encounter_performed_1.start_dt AS hqmf_cypress_ep_encounter_performed_start_dt,
                        encounter_performed_1.end_dt AS hqmf_cypress_ep_encounter_performed_end_dt,
                 ...
                 WHERE encounter_performed_1.patient_id = patient_base.base_patient_id
                   AND (CAST(encounter_performed_1.negation AS BIT) IS NULL
                        OR CAST(encounter_performed_1.negation AS BIT) = 0)) AS dc_42
              UNION SELECT dc_43.hqmf_cypress_ep_encounter_performed_patient_id AS patient_id,
              ...
              FROM
                (SELECT encounter_performed_1.patient_id AS hqmf_cypress_ep_encounter_performed_patient_id,
                 ...
                 AND code_lists_10.code_list_id = '2.16.840.1.113883.3.526.3.1285'
                 WHERE encounter_performed_1.patient_id = patient_base.base_patient_id
                   AND (CAST(encounter_performed_1.negation AS BIT) IS NULL
                        OR CAST(encounter_performed_1.negation AS BIT) = 0)) AS dc_45) AS anon_4)) 
						THEN cast( 1 as bit) 
					   ELSE cast(0 as bit)
